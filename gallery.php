		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 fh5co-heading animate-box">
					...
					<div class="row">
						<div class="col-md-6">
							<p>A lo largo de este tiempo hemos formado parte de momentos inolvidables de nuestros clientes, guardamos recuerdos de algunos eventos donde nuestros productos formaron parte de la alegria de cada ocacion. </p>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<p>Es un gusto para nosotros que formes parte de nuestra distingida clientela, es un placer atenderete.</p>
